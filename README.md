...
Die sichtbare App-Version steht ausschließlich in `version.json`. Für ein neues Release dort beispielsweise `1.1.1` auf `1.2.0` ändern, die gewünschten Dateien anpassen und alles gemeinsam pushen. Installierte Apps laden das Release erst, wenn im Info-Tab ausdrücklich nach Updates gesucht und der Download bestätigt wird.
